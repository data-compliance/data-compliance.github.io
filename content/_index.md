...
<a href="https://github.com/swiss-ai/robots-txt-compliance" style="background: linear-gradient(135deg,rgb(25, 83, 141) 0%,rgb(25, 49, 79) 100%); color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; display: inline-flex; align-items: center; gap: 8px; font-weight: 600; box-shadow: 0 4px 15px rgba(17, 38, 69, 0.5); transition: transform 0.2s, box-shadow 0.2s;">
🐙 GitHub
</a>
